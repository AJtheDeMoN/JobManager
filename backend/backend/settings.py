...
SECRET_KEY = 'django-insecure-!6g$30=dq(wpw@r#8#r1l9h@eji=ovr38&0@vi%zz^^2=s17=f'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=366), # Optional: refresh token valid for a bit longer
